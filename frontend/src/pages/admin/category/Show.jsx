      ...
      <div className="bg-white p-8 rounded-md w-full">
        <div className=" flex items-center justify-between">
          <div>
            ...
            <span className="text-xs">Show category item</span>
          </div>
          <div className="flex items-center justify-between">
            <Link
              to={"/admin/categories"}
            ...
            <div className="bg-white  p-5 mb-3  h-full rounded-md ">
              ...
              <div className="flex flex-wrap gap-4">
                {category?.image && (
                  <img
                    className="w-40"
                    src={AppURL.ImageUrl + category?.image}
                    alt=""
                  />
                )}
              </div>
              ...
              <table className="mt-2 min-w-full">
                <tbody className="table-auto ">
                  ...
                  <tr className="border-b">
                    ...
                    <td className="px-6 py-4">
                      ...
                      >
                        <span
                          className={`absolute ${
                            category?.status == 1 ? "bg-green-200" : "bg-red-400"
                  ...
                  <tr className="border-b">
                    ...
                    <td className="px-6 py-4">{category?.metadesc}</td>
                  </tr>
                  <tr className="border-b">
                    <th className="w-52 text-left uppercase px-6 py-4">
                      Meta key
                    </th>
                    <td className="px-6 py-4">{category?.metakey}</td>
                  </tr>
                  <tr className="border-b">
                    <th className="w-52 text-left uppercase px-6 py-4">
                      Ngày tạo
